...
```html
<script src="https://cdn.bootpay.co.kr/js/bootpay-2.0.15.min.js" type="application/javascript"></script>
```
...
<script type="text/javascript">
    //jQuery 수정 버전을 로드한다.
    require(["https://cdn.bootpay.co.kr/js/bootpay-2.0.15.min.js"], function(BootPay) {
        BootPay.request({
            // anyThing Data
        });
    });
